...
class Networking {
    var session = URLRequest(url: URL(string:"https://tyfnvcpyad.execute-api.us-west-1.amazonaws.com/default/helloworldserverless")!)
    ...
    func exampleGet() async {
        let awsurl = URL(string: "https://tyfnvcpyad.execute-api.us-west-1.amazonaws.com/default/helloworldserverless")!
        let mainsesh = URLSession(configuration: .default)
        let request = URLRequest(url: awsurl)
        do {
